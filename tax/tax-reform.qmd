...
1. Reform the personal allowance. The personal allowance and minimum wage could be rolled into one idea. A set tax free minimum rate that all workers should be paid. Simply, if it costs a certain [amount to live](/general/basic-necessity.md) (the minimum wage) then this should be an untaxed sum, available to everyone.

# LVT
A land value tax is the next progressive suggestion but would require a big reform of the current system. It would be complex, require a slow roll in but is likely to be one of the best options.