...
To attempt to define what this means: 1. your ideals won't always appeal to the majority and implementation may not be feasible, so be open to discussion 2. compromise isn't a bad thing, in fact it means finding a solution that works 3. compromise doesn't have to mean a worse idea, perhaps it even means finding a better solution to a problem.
...
[Approach](/meta/approach.qmd) discusses the 'system' with which this project should be approached.